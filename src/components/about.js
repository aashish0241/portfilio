          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <h2 className="mb-5 text-4xl font-bold text-dark text-blue-500 sm:text-[40px]/[48px]">
                Mern Stack Developer
                </h2>
                <p className="mb-5  text-white  text-xl 
                 text-body-color dark:text-dark-6">
                My journey in the world of development began with a 
                curiosity to understand how technology shapes our lives. 
                
                </p>
                <p className="mb-8   text-white  text-xl text-body-color dark:text-dark-6">
                Starting with basic coding exercises, I quickly found my passion 
                in frontend development – the art of 
                crafting visually appealing 
                and user-friendly interfaces that bridge the gap between users and technology.
                </p>
                <a href="/about">
