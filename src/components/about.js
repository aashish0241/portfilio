  ...
  return (
    <>
      <section className="overflow-hidden pt-20 pb-12 pl-3 lg:pt-[120px]  bg-[#453952] lg:pb-[90px] dark:bg-dark">
        <h1 className="flex justify-center items-center m-1 text-6xl font-bold">
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  ...
                  <div className="py-3 sm:py-4">
                    <img src={Back} alt="" className="w-full rounded-2xl" />
                  </div>
                </div>
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-10 my-4">
                    <img src={Aashish} alt="" className="w-full rounded-2xl" />
