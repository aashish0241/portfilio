...
const About1 = () => {
  ...
  return (
    <>
      <section className="overflow-hidden shadow-2xl shadow-red-300 pt-20 pb-12 pl-3 lg:pt-[120px] bg-[#ffff] lg:pb-[90px]">
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                      ...
                      className={`w-full rounded-2xl fade ${
                        scrollY > 400 ? "fade-in" : "fade-out"
                      } ${scrollY > 400 ? "rotate rotate-down" : ""}`}
                    />
                  </div>
                  <div className="py-3 sm:py-4">
                    <img
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <h2 className="mb-5 text-4xl font-bold text-dark text-blue-500 sm:text-[40px]/[48px] text-black">
                ...
                <p className="mb-5 text-black text-xl text-body-color dark:text-dark-6">
                  ...
                  to understand how technology shapes our lives.
                </p>
                <p className="mb-8 text-black text-xl text-body-color dark:text-dark-6">
                  Starting with basic coding exercises, I quickly found my
                  passion in frontend development – the art of crafting visually
                  appealing and user-friendly interfaces that bridge the gap
                  between users and technology.
                </p>
                <a href="/about">
                  {url.pathname !== "/about" && (
                    <button className="bg-blue-300 hover:bg-blue-500 m-3 border-dark dark:border-dark-2 border rounded-full inline-flex items-center justify-center py-3 px-7 text-center text-base sm:text-lg lg:text-xl font-medium text-white hover:bg-body-color hover:border-body-color disabled:bg-gray-3 disabled:border-gray-3 disabled:text-dark-5">
                      Learn More
                    </button>
                  )}
                </a>
