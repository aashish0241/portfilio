...
const cards = [
  ...
  },
  {
    ...
    description: 'Developing robust server-side solutions to handle data storage, authentication, and more.',
  },
  {
    icon: <FaDatabase className="text-5xl text-purple-500" />,
    title: 'Database Design',
    description: 'Designing and optimizing databases to ensure efficient data storage and retrieval.',
  },
  {
    icon: <FaPlug className="text-5xl text-indigo-500" />,
    title: 'API Development',
    description: 'Creating APIs for seamless communication between front-end and back-end systems.',
  },
];
  ...
  return (
    ...
    <div className='overflow-hidden pt-2 pb-12 lg:pt-[12px]  bg-[#453952] lg:pb-[90px] dark:bg-dark'>
      <div className="text-center mb-8">
        ...
        <p className=" lg:text-5xl sm:text-3xl font-bold text-[#0cf5b3]">Expertise That Powers Your Web Success</p>
      </div>
          ...
          >
            <div className="flex flex-col h-full bg-gray-800 shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="flex flex-col justify-between px-6 py-4 h-full">
                <h2 className="text-2xl font-bold mb-2 text-center text-white">{card.title}</h2>
