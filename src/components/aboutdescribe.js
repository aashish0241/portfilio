  ...
  return (
    <div className="overflow-hidden  text-white pb-12 lg:pt-[1px]  bg-[#453952] lg:pb-[90px] dark:bg-dark">
      <div className="p-1 m-6">
        ...
        <p>
          I was born on August 17, 2003, in the charming town of Pokhara, Nepal.
          My journey into the world of web development, blogging, and
        ...
        <p>
          ...
          technologies like React, Node.js, and MongoDB. I've had the privilege
          of designing and developing various websites, showcasing my ability to
          create visually appealing and functional web solutions.
        </p>
        ...
        <p>
          ...
          topics, including web development tutorials and industry trends. It's
          been an incredible journey, and I'm grateful that my writing has not
          only educated but also inspired fellow developers and tech
          enthusiasts.
        </p>
        ...
        <p>
          ...
          client requirements, deliver high-quality work, and meet deadlines has
          earned me a strong reputation as a freelance web developer and content
          creator.
        </p>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            My blog has gained a dedicated readership that values my informative
            and engaging content.
          </li>
          <li>
            Positive feedback from satisfied clients has been a testament to my
            freelance work's quality and professionalism.
          </li>
        </ul>
        ...
        <p>
          ...
          contribute to open-source projects, collaborate with industry leaders,
          and expand my blogging platform to reach an even wider audience.
        </p>
        ...
        <p>
          ...
          continues to propel me forward on a path of success. I'm excited about
          the opportunities that lie ahead in the digital world.
        </p>
      </div>
    </div>
  );
