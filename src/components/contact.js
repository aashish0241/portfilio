...
const Contact = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-[#d1760f] text-white py-20 dark:bg-dark lg:py-[120px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      Tallakot ,Pokhara-kaski, Nepal 33700
                    </p>
                  </div>
                </div>
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-[#680ead] p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
