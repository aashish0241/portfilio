  ...
  return (
    ...
    <div className="container mx-auto p-8 bg-[#161b57] overflow-hidden pt-1 pb-12 lg:pt-[10px]   lg:pb-[90px] dark:bg-dark">
      <div className="text-center mb-8">
        ...
        <p className="text-lg font-bold text-[#0cf5b3]">Check Out My Work Progress in different sector</p>
      </div>
        ...
        {cards.map((card, index) => (
          ...
          >
            <div className="relative h-64 rounded-lg overflow-hidden">
              ...
              />
              <h2 className="text-2xl text-white font-bold mb-2">{card.title}</h2>
              <div className="absolute top-0 left-0 w-full h-full bg-black opacity-0 hover:opacity-70 transition-opacity 
